...
{
    public readonly struct CollisionTouch
    {
    ...
    public class TouchPayloadBuilder
    {
        ...
        public TouchPayloadBuilder(CollisionTouch payload)
        {
        ...
        public CollisionTouch ToTouchPayload()
        {
            return new CollisionTouch(Contact, Normal, UV, Color, Source, Target, Dynamics, Seperation);
        }
    }
