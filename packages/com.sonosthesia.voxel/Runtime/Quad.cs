...
namespace Sonosthesia.Builder
{
	...
	public class Quad
	{
		...
		public Quad(VoxelUtils.BlockSide side, Vector3 offset, VoxelUtils.BlockType bType)
	    {
			...
			Vector2 uv00 = VoxelUtils.blockUVs[(int)bType,0];
	        Vector2 uv10 = VoxelUtils.blockUVs[(int)bType, 1];
			Vector2 uv01 = VoxelUtils.blockUVs[(int)bType, 2];
			Vector2 uv11 = VoxelUtils.blockUVs[(int)bType, 3];
	        ...
	        switch (side)
	        {
				case VoxelUtils.BlockSide.BOTTOM:
				...
				case VoxelUtils.BlockSide.TOP:
					...
					break;
				case VoxelUtils.BlockSide.LEFT:
					...
					break;
				case VoxelUtils.BlockSide.RIGHT:
					...
					break;
				case VoxelUtils.BlockSide.FRONT:
					...
					break;
				case VoxelUtils.BlockSide.BACK:
