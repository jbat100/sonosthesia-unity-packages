...
{
    [CreateAssetMenu(fileName = "MIDIMultiChannelRackSetup", menuName = "Sonosthesia/Instrument/MIDIMultiChannelRackSetup")]
    public class MIDIMultiChannelRackSetup : ScriptableObject
    {
        [Serializable]
