...
namespace Sonosthesia.Mesh
{
    public struct UVSphere : IMeshGenerator
    {
        ...
        // first pass creates the vertices, but no triangles
        private void ExecuteSeam<S>(S streams) where S : struct, IMeshStreams
        {
        ...
        private void ExecuteRegular<S>(int u, S streams) where S : struct, IMeshStreams
        {
            ...
            streams.SetTriangle(ti + 0, vi + int3(shiftLeft - 1, 0, -1));
        }
