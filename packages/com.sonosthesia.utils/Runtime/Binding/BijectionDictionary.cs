...
namespace Sonosthesia.Utils
{
    ...
    // adapted from:
    // https://github.com/ColmBhandal/CsharpExtras/blob/develop/CsharpExtras/Map/Dictionary/IBijectionDictionary.cs
    // https://github.com/ColmBhandal/CsharpExtras/blob/develop/CsharpExtras/Map/Dictionary/BijectionDictionaryImpl.cs
    ...
    public class BijectionDictionary<TKey, TValue> : IBijectionDictionary<TKey, TValue>
    {
        ...
        public IBijectionDictionary<TValue, TKey> Reverse => _reverse ??= new BijectionDictionary<TValue, TKey>(_reverseDelegate, this);

        public BijectionDictionary()
        {
        }

        public BijectionDictionary(IDictionary<TKey, TValue> dictionary)
        {
        ...
        private BijectionDictionary(IDictionary<TKey, TValue> dictionary, BijectionDictionary<TValue, TKey> reverseDictionary)
        {
            _delegate = dictionary;
