...
{
    // found through https://docs.unity3d.com/Packages/com.unity.graphtools.foundation@0.9/manual/index.htm
    ...
    // Joao Portela
    // ----------------------------------------------------------------------------
    public class DisposingCircularBuffer<T> : IReadOnlyList<T>, IDisposable where T : IDisposable
    {
        readonly T[] m_Buffer;
        ...
        public DisposingCircularBuffer(int capacity)
            : this(capacity, new T[] { })
        {
        }
        ...
        /// any enumerable.
        /// </param>
        public DisposingCircularBuffer(int capacity, T[] items)
        {
            if (capacity < 1)
            {
