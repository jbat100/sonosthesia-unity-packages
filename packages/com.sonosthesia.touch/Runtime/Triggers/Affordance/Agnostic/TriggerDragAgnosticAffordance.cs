...
namespace Sonosthesia.Touch
{
    public class TriggerDragAgnosticAffordance : DragAgnosticAffordance<TriggerEvent, TriggerEndpoint, TriggerDragAgnosticAffordance>
    {
        ...
        {
            public Controller(Guid eventId, TriggerDragAgnosticAffordance affordance) : base (eventId, affordance)
            {
                
            }

            protected override bool GetOriginScale(bool initial, TriggerEvent value, ref Vector3 origin) => false;
            
            protected override bool GetTargetScale(bool initial, TriggerEvent value, Vector3 origin, ref Vector3 target) => false;
